...
public class ClienteStandaloneCharacterRestService {
	...
	public static void main(String[] args) throws RestClientException, URISyntaxException {
		...
		variables.put("id", "hommer");
		
		ResponseEntity<Character> entidadHommer = restTemplate.getForEntity("http://localhost:8080/12-SimpsonsRest/rest/characters/{id}", com.simpson.entidades.Character.class, variables);
		
		Character hommer = entidadHommer.getBody();
