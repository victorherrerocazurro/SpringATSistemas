...
public class CharactersRestService {
	...
	public com.simpson.entidades.Character consultaUnPersojae(@PathVariable String id) {
		return new com.simpson.entidades.Character("hommer", "Hommer Jay Simpson", 50, "abraham", "mona", Arrays.asList(new String[]{"bart", "lisa", "maggie"}), Arrays.asList(new String[]{"herb", "abbie"}));
	}
	...
	// http://localhost:8080/12-SimpsonsRest/rest/characters/hommer/father
	
	@RequestMapping(path = "/{id}/father", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	public com.simpson.entidades.Character consultaPadreDePersonaje(@PathVariable String id) {
		return null;
	}

	// http://localhost:8080/12-SimpsonsRest/rest/characters/hommer/grandfather
	
	@RequestMapping(path = "/{id}/grandfather", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
	public com.simpson.entidades.Character consultaAbueloDePersonaje(@PathVariable String id) {
		return null;
	}
