...
public class PruebaControlador {
	...
	@Test
	public void pruebaControladorFuncionamientoDeseado() throws URISyntaxException, Exception {
		mockMvc.perform(get(new URI("/")).param("dato", "pepe"))
			.andExpect(status().isOk()).andExpect(model().attributeExists("resultado"));
	}
	
	@Test
	public void pruebaControladorFuncionamientoError() throws URISyntaxException, Exception {
